...
const Hero = () => {
  ...
  return (
    <div className='h-screen flex flex-col items-center justify-center gap-14 bg-light text-center'>
      <h1 className='text-4xl md:text-4xl font-semibold'>Luxery cars on Rent</h1>

      <form onSubmit={handleSearch} className='felx flex-col md:flex-row items-start md:items-center justify-between p-6 rounded-lg md:rounded-full w-full max-w-80 md:max-w-200 bg-white' >
        <div className='flex flex-col md:flex-row items-start md:items-center gap-10 min-md:ml-18'>
